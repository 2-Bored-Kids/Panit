...
public class BetterStift extends Buntstift {
    ...
    public BetterStift(Bildschirm screen) {
        ...
        try {
            ...
            this.frame = (JFrame)SwingUtilities.getWindowAncestor(Utils.getPanel(screen));
    ...
    public void drawToScreen() {
        this.screenGraphics.drawImage(buffer.getSubimage(Consts.MENU_X, 0, this.buffer.getWidth() - Consts.MENU_X, this.buffer.getHeight()), Consts.MENU_X, 0, this.kenntPrivatschirm);
    }
