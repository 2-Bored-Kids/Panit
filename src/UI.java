...
public class UI {
  ...
  public static void init() {
    ...
    a_black = new ColorOption(20, 380, 130, 20, "Schwarz", Colors.BLACK);
    ...
    a_orange = new ColorOption(20, 520, 130, 20, "Orange", Colors.ORANGE);
    a_colors.fuegeEin(a_orange);
    a_brown = new ColorOption(20, 540, 130, 20, "Braun", Colors.BROWN);
